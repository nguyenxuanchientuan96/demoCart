...
$current_url = base64_encode($_SERVER['REQUEST_URI']);
    ...
    if ($results) {
        ...
        while($obj = $results->fetch_object())
        {
            ...
            echo '<div class="product-content"><h3>'. 'Ten san pham: '   .$obj->name.'</h3>';
            echo '<div class="product-desc">'.'Thong tin mieu ta: '.$obj->description.'</div>';
            echo '<div class="product-info">Giá:'.$currency.$obj->price.' <br> Nhap so luong sp muon mua'.' 
            <input type="text" size="5" name="product_qty" value="1"><button class="add_to_cart">Thêm vào giỏ hàng</button></div>';
            echo '</div>';
